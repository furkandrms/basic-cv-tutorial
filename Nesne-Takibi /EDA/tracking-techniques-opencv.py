...
OPENCV_OBJECT_TRACKERS = {
    ...
    "csrt": cv2.legacyçTrackerCSRT_create,
...
gt = pd.read_csv("/Users/furkandurmus/Desktop/Computer Vision/Nesne-Takibi /EDA/gt_new.txt")

video_path = "/Users/furkandurmus/Desktop/Computer Vision/Nesne-Takibi /MOT17-13-SDP.mp4"
...
if len(track_df) != 0:
    print("Tracking method: ",trackers)
    print("Time: ",time_diff)
    print("Number of frame to track (gt): ",len(gt))
    print("Number of frame to track (track success): ",success_track_frame)
